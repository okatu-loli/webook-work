...
import (
	...
	"github.com/okatu-loli/webook/internal/web"
	"github.com/okatu-loli/webook/internal/web/middleware"
...
func initDB() *gorm.DB {
	db, err := gorm.Open(mysql.Open("root:root@tcp(localhost:13316)/webook?parseTime=true"))
	if err != nil {
		// 我只会在初始化过程中 panic
